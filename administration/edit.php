...
<?php
	...
	/* start off by getting the original data and then placing it in the form::*/
	...
	// create post code:
	//$sql = "UPDATE posts SET(image, title, body, uploaddate, uploadedby, page_views) VALUES ('$image', '$title', '$body', '$date', '$id', '0')";
                ...
                <div class="p-5">
                  ...
                  <form name="" action="create.php" method="POST" class="user" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                    	<label>Title</label>
                      	<input id="titleField" value="<?php echo $postTitle?>" name="title" type="text" class="form-control form-control-user" >
                    </div>

                    <div class="form-group">
                    	<label>Post</label>
                      	<textarea value="<?php echo htmlspecialchars_decode($postbody) ?>" id="postField" name="body" rows="5" cols="5" type="text" class="form-control form-control-user" ></textarea>
                    </div>
